...
function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
     $dv .= '<li>';
     $dv .= "<a href = '/phpmotors/vehicles/index.php?action=vehicleView&Vehicle=$vehicle[invId]'><img src='$vehicle[invThumbnail]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
     $dv .= '<hr>';
     $dv .= "<a href = '/phpmotors/vehicles/index.php?action=vehicleView&Vehicle=$vehicle[invId]'><h2>$vehicle[invMake] $vehicle[invModel]</h2></a>";
...
// Builds a block of html for a review.
...
// Builds a block of html for the review list.
